...
export default function BookingForm({ carModel, carName, carId, vendorEmail }: BookingFormProps) {
  ...
  const handleSubmit = async (formData: any) => {
    ...
    const formDataWithProduct = { ...formData, carModel, carName, carId, vendorEmail };
